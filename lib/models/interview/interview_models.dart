/// Mirrors `InterviewOtherParty` in `interview_schema.py`.
class InterviewOtherParty {
  ...
  factory InterviewOtherParty.fromJson(Map<String, dynamic> json) => InterviewOtherParty(
...
class InterviewModel {
  ...
  factory InterviewModel.fromJson(Map<String, dynamic> json) => InterviewModel(
        ...
        scheduledAt: DateTime.tryParse(json['scheduled_at']?.toString() ?? '')?.toLocal() ?? DateTime.now(),
        durationMinutes: json['duration_minutes'] ?? 30,
        status: json['status']?.toString() ?? 'scheduled',
        notes: json['notes'],
        meetingUrl: json['meeting_url']?.toString() ?? '',
        startedAt: json['started_at'] != null ? DateTime.tryParse(json['started_at'].toString())?.toLocal() : null,
        endedAt: json['ended_at'] != null ? DateTime.tryParse(json['ended_at'].toString())?.toLocal() : null,
...
class JoinInterviewResult {
  ...
  factory JoinInterviewResult.fromJson(Map<String, dynamic> json) => JoinInterviewResult(
        meetingUrl: json['meeting_url']?.toString() ?? '',
