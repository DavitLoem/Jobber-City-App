...
class JobListView extends GetView<JobListViewController> {
        ...
        title: Obx(
          () => Text(
            controller
                .pageTitle
                .value
                .tr, // 🟢 Added .tr for dynamic page title translation
            style: TextStyle(
              color: theme.textTheme.bodyLarge?.color,
              fontSize: 18,
            ...
            Obx(() {
              if (controller.listType.value == 'recent') {
                return Padding(
                  ...
                  child: _buildCategoryFilter(categoryCtrl, isDark),
                );
              }
  ...
  Widget _buildCategoryFilter(CategoryController categoryCtrl, bool isDark) {
    return SizedBox(
      height: 38,
      child: Obx(() {
          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                child: Text(
                  item['name']!
                      .tr, // 🟢 Added .tr to translate 'All' and potential categories
                  style: TextStyle(
                    color: isSelected
                        ? Colors.white
                        : (isDark
